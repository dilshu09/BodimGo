    ...
    return (
        <div className="p-8 max-w-7xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-slate-600 mt-2">Action items requiring your attention</p>
            </div>
                ...
                {tasks.length === 0 ? (
                    ...
                    tasks.map((task) => (
                        <div
                            ...
                            className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex items-center justify-between hover:border-blue-300 transition-colors group cursor-pointer"
                        >
                            <div className="flex items-start gap-4">
                                <div className={`p-3 rounded-full ${task.status === "urgent" ? "bg-red-100 text-red-600" : "bg-blue-100 text-blue-600"
                                    }`}>
