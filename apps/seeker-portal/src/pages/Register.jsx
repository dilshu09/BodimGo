        ...
        <div className="min-h-screen flex items-center justify-center bg-neutral-50 dark:bg-slate-950 px-4 py-12 transition-colors duration-200">
            <div className="w-full max-w-md bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-xl border border-neutral-100 dark:border-slate-800 transition-all">
                <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-500 dark:text-slate-400 text-sm mt-1">Sign up to find your perfect place</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        <label className="block text-xs font-bold text-neutral-500 dark:text-slate-400 uppercase tracking-wide mb-2">Full Name</label>
                        <input
                            type="text"
                            required
                    ...
                    <div>
                        <label className="block text-xs font-bold text-neutral-500 dark:text-slate-400 uppercase tracking-wide mb-2">Phone Number</label>
                        <input
                            type="tel"
                            required
                            className="w-full px-4 py-3 rounded-lg border border-neutral-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-neutral-900 dark:text-white focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder:text-neutral-400 dark:placeholder:text-slate-500"
                    ...
                    <div>
                        <label className="block text-xs font-bold text-neutral-500 dark:text-slate-400 uppercase tracking-wide mb-2">Password</label>
                            ...
                            <div className="mt-2">
                                <div className="flex gap-1 h-1.5 mb-1">
                                    {[1, 2, 3, 4].map((level) => (
                                        <div
                                            key={level}
                                            className={`flex-1 rounded-full transition-all duration-300 ${strength >= level ? strengthColors[strength] : 'bg-gray-100 dark:bg-slate-800'}`}
                                        />
                                    ))}
                                </div>
                                <p className="text-xs text-neutral-500 dark:text-slate-400 text-right">strength: <span className="font-bold">{strengthLabels[Math.max(0, strength - 1)] || 'Weak'}</span></p>
                            </div>
                        )}
                    </div>

                    <div>
                        <label className="block text-xs font-bold text-neutral-500 dark:text-slate-400 uppercase tracking-wide mb-2">Confirm Password</label>
                        <div className="relative">
                            <input
                    ...
                    <p className="text-xs text-neutral-500 dark:text-slate-400 mt-4">
